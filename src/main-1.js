    ...
    this.objetoUsuarios={
      Usuarios:[
        ...
        Camapañas:[
          {
            id: '1',
            nombreCamapaña: 'goforus',
            director:'sebas',
            empresa: 'adidas',
            equipo:'1',
            estado:'1',
            fechaDeInicio:'12-12-2023',
          ...
          },
          {
            ...
            equipo:'2',
            estado:'2',
            fechaDeInicio:'02-09-2023',
            fechaDeFin:'31-11-2023'
          }
        ],
        Equipos:[
          {
...
getCampañaActiva(campañaId) {
  ...
  abrirAgregarCampaña() {
    ...
    modal.style.display = "block";
    modal.style.background = "rgb(0,5,5,0.7)";
  ...
  abrirAgregarEquipo() {
    ...
    modal.style.display = "block";
    modal.style.background = "rgb(6 ,5,0,0.7)";
